...
namespace Msn.InteropDemo.Data.Migrations
{
    ...
    [Migration("20191230183450_add_nomivacImmunizationId")]
    partial class add_nomivacImmunizationId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Msn.InteropDemo.Entities.Evoluciones.EvolucionDiagnosticoCie10", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("EvolucionDiagnosticoId");

                    b.HasKey("Id");

                    b.HasIndex("EvolucionDiagnosticoId");

                    b.ToTable("EvolucionDiagnosticoCie10");
                });
            ...
            modelBuilder.Entity("Msn.InteropDemo.Entities.Evoluciones.EvolucionVacunaAplicacion", b =>
                {
                    ...
                    b.Property<int?>("AplicacionNomivacEsquemaId");

                    b.Property<int?>("AplicacionNomivacVacunaId");
            ...
            modelBuilder.Entity("Msn.InteropDemo.Entities.Nomivac.NomivacEsquema", b =>
                {
                    b.Property<int>("Id");

                    b.Property<int?>("AplicacionDiaMax");

                    b.Property<int?>("AplicacionDiaMin");
                    ...
                    b.ToTable("NomivacEsquema");
                });

            modelBuilder.Entity("Msn.InteropDemo.Entities.Nomivac.NomivacVacuna", b =>
                {
                    b.Property<int>("Id");
                    ...
                    b.Property<decimal>("SctId")
                        .HasColumnType("numeric(18,0)");

                    b.Property<string>("SctTerm")
                        .IsRequired()
                        .HasMaxLength(250)
                        .IsUnicode(true);
                    ...
                    b.ToTable("NomivacVacuna");
                });

            modelBuilder.Entity("Msn.InteropDemo.Entities.Nomivac.NomivacVacunaEsquema", b =>
                {
                    b.Property<int>("NomivacEsquemaId");

                    b.Property<int>("NomivacVacunaId");

                    b.HasKey("NomivacEsquemaId", "NomivacVacunaId");

                    b.HasIndex("NomivacVacunaId");

                    b.ToTable("NomivacVacunaEsquema");
                });
            ...
            modelBuilder.Entity("Msn.InteropDemo.Entities.Pacientes.Paciente", b =>
                {
                    ...
                    b.Property<string>("PrimerApellidoSoundex")
                        .IsRequired()
                        .HasMaxLength(4)
                        .IsUnicode(false);
                    ...
                    b.Property<string>("PrimerNombreSoundex")
                        .IsRequired()
                        .HasMaxLength(4)
                        .IsUnicode(false);
            ...
            modelBuilder.Entity("Msn.InteropDemo.Entities.Sqlite.SqliteSequence", b =>
                {
            ...
            modelBuilder.Entity("Msn.InteropDemo.Entities.Evoluciones.EvolucionDiagnosticoCie10", b =>
                {
                    b.HasOne("Msn.InteropDemo.Entities.Evoluciones.EvolucionDiagnostico", "EvolucionDiagnostico")
                        .WithMany("Cie10Mapeos")
                        .HasForeignKey("EvolucionDiagnosticoId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("Msn.InteropDemo.Entities.Nomivac.NomivacVacunaEsquema", b =>
                {
                    b.HasOne("Msn.InteropDemo.Entities.Nomivac.NomivacEsquema", "NomivacEsquema")
                        .WithMany()
                        .HasForeignKey("NomivacEsquemaId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Msn.InteropDemo.Entities.Nomivac.NomivacVacuna", "NomivacVacuna")
                        .WithMany()
                        .HasForeignKey("NomivacVacunaId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
